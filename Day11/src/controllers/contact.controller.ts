...
import { ContactServiceV2 } from "../services/contact.service";
import { contactSchema, updateContactSchema, contactListQuerySchema } from "../validators/contact.schema";
...
export const getAllContacts = async (req: Request,res: Response,next: NextFunction): Promise<void> => {
  try {
    ...
    const result = await service.getAllContacts(validation.data, req.user!);
...
export const getContactById = async (req: Request,res: Response,next: NextFunction): Promise<void> => {
  try {
    ...
    const contact = await service.getContactById(id, req.user!);
...
export const createContact = async (req: Request,res: Response,next: NextFunction): Promise<void> => {
  try {
    ...
    const contact = await service.createContact(validation.data, req.user!);
...
export const updateContact = async (req: Request,res: Response,next: NextFunction): Promise<void> => {
  try {
    ...
    const contact = await service.updateContact(id, validation.data, req.user!);
...
export const deleteContact = async (req: Request,res: Response,next: NextFunction): Promise<void> => {
  try {
    ...
    await service.deleteContact(id, req.user!);
